...
ent-BurnAutoInjector = burn auto-injector
    .desc = A rapid dose of dermaline and kelotane, intended for combat applications.
...
ent-AirlossAutoInjector = airloss auto-injector
    .desc = A rapid dose of saline, dexalin plus, and tranexamic acid, intended to get someone up quickly.
...
ent-Stimpack = hyperzine injector
    .desc = Contains enough hyperzine for you to have the chemical's effect for 30 seconds. Use it when you're sure you're ready to throw down. Contains epinephrine and tranexamic acid.
...
ent-CombatMedipen = combat medipen
    .desc = A single-use medipen containing chemicals that regenerate most types of damage. Contains bicaridine, omnizine, dermaline, and hemostatic powder.
ent-Hypopen = pen
    .desc = A dark ink pen.
    .suffix = Hypopen
...
ent-BaseAnomalyAutoInjector = anomaly auto-injector
    .desc = A single-use self-injecting injector that infects a humanoid with a random anomaly within a minute of injection.
ent-AnomalyAutoInjector = anomaly auto-injector
    .desc = Injects one of the basic anomalies into the humanoid.
ent-AnomalyAutoInjectorUplink = anomaly auto-injector
    .desc = Injects a random anomaly from the entire existing spectrum into the humanoid.
ent-XenoArtifactThrowingAutoInjector = artifact throwing auto-injector
    .desc = Activates upon being thrown, piercing into a living creature and injecting artifact particles once.
