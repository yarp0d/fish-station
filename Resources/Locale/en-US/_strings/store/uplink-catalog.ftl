...
uplink-syndicate-pai-desc = A Syndicate pAI with syndicate radio and a built-in module shop (15 memory). Unlock combat medicine, auto-dispenser, doorjack, crew monitors, cameras and support tools.
