...
uplink-mosin-speedloader-name = Обойма (7,62R)
...
uplink-l6-saw-bundle-desc = Ещё больше дакки: культовый лёгкий пулемёт L6 в комплекте с 3 коробами патронов по 200 патронов каждый. Штурмовая версия, что совершенно не сковывает движение, ценой точности.
