...
ent-BurnAutoInjector = автоинъектор физ-повреждений
    .desc = Экспресс-доза дермалина и келотана, предназначенная для применения в боевых условиях.
...
ent-AirlossAutoInjector = автоинъектор гипоксии
    .desc = Быстродействующая доза физраствора, дексалина плюс и транексамовой кислоты, предназначенная для быстрого приведения человека в чувство.
...
ent-Stimpack = стимпак
    .desc = Инъектор, содержащий дозу стимулятора на 30 секунд. Также содержит эпинефрин и транексамовую кислоту. Используйте, когда уверены, что успеете закончить до наступления побочных эффектов прекращения действия.
...
ent-CombatMedipen = боевой медипен
    .desc = Одноразовый медипен, содержащий химические вещества, восстанавливающие большинство видов повреждений. Содержит бикаридин, омнизин, дермалин и кровоостанавливающую пудру.
